...
<section aria-label="Prepara tu negocio para el verano 2026–2027" class="parallax-section parallax-refined" style="--parallax-img:url('../img/3.png')"><div class="parallax-inner"><div class="parallax-copy"><div class="eyebrow">Saltos del Laja</div><h2>Prepara tu negocio para el verano 2026–2027</h2><p>Publica tu alojamiento, restaurante, camping, cafetería, emprendimiento o experiencia con una ficha clara, visual y orientada a reservas.</p><div class="parallax-actions"><a class="btn white" href="planes.php">Ver planes</a><a class="btn ghost" href="contacto.php">Contactar</a></div></div><div class="parallax-stats refined"><div class="parallax-stat"><strong><?= count($publishCategories) ?></strong><span>categorías activas para postular</span></div><div class="parallax-stat"><strong>CRM</strong><span>gestión de tarjetas y tags</span></div></div></div></section>
