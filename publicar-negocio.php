...
<section class="publish-section" id="planes"><div class="container"><div class="pro-head"><div><div class="eyebrow dark">Opciones comerciales</div><h2>Elige cómo quieres aparecer en la guía</h2></div><p>Planes preparados para negocios de temporada, comercios permanentes y marcas que quieren visibilidad en el destino.</p></div><div class="publish-plan-grid"><article><span>Básico anual</span><h3>Ficha esencial</h3><p>Nombre, descripción, categoría, tags, WhatsApp, ubicación e imagen principal.</p></article><article class="featured"><span>Destacado anual</span><h3>Más visibilidad</h3><p>Prioridad visual en categoría, ficha completa, más fotos y etiqueta destacado.</p></article><article><span>Premium anual</span><h3>Contenido + SEO</h3><p>Ficha, artículo SEO, presencia en categoría, mapa y apoyo en difusión.</p></article><article><span>Auspicio</span><h3>Campaña mensual</h3><p>Banner o presencia especial para marcas, eventos y servicios turísticos.</p></article></div></div></section>
<section class="publish-section soft" id="solicitud"><div class="container publish-form-layout"><aside class="publish-form-aside"><div class="eyebrow dark">Solicitud de publicación</div><h2>Cuéntanos de tu negocio</h2><p>Completa el formulario y lo recibiremos por WhatsApp para revisión, confirmación de plan y carga final en el CRM.</p><div class="publish-aside-list"><span>✓ Categorías dinámicas desde el CRM</span><span>✓ Tags para navegación de tarjetas</span><span>✓ Diseño alineado a la guía turística</span></div></aside><form class="publish-form-card" id="registerForm"><div class="publish-form-section"><h3>Datos principales</h3><div class="form-grid"><div class="form-field"><label>Nombre del negocio</label><input name="Nombre del negocio" placeholder="Ej: Cabañas Río Laja" required=""/></div><div class="form-field"><label>Nombre del encargado</label><input name="Encargado" placeholder="Nombre y apellido"/></div><div class="form-field"><label>WhatsApp</label><input name="WhatsApp" placeholder="+56 9 1234 5678" required=""/></div><div class="form-field"><label>Correo</label><input name="Correo" placeholder="contacto@negocio.cl" type="email"/></div></div></div><div class="publish-form-section"><h3>Categoría y tags</h3><label class="publish-label">Categorías disponibles</label><div class="publish-category-grid"><?php foreach ($publishCategories as $category): ?><label><input type="checkbox" name="Categorías" value="<?= publish_h($category['menu_label']) ?>"> <span><?= publish_h($category['menu_label']) ?></span></label><?php endforeach; ?></div><div class="form-field"><label>Tags sugeridos para tu tarjeta</label><input name="Tags" placeholder="Ej: Pet friendly, Reservas, Vista, Familias, Cafetería"/></div></div><div class="publish-form-section"><h3>Publicación</h3><div class="form-grid"><div class="form-field"><label>Ubicación / sector</label><input name="Ubicación" placeholder="Km 480, Saltos del Laja, Cabrero..." required=""/></div><div class="form-field"><label>Instagram</label><input name="Instagram" placeholder="@usuario"/></div><div class="form-field"><label>Plan de interés</label><select name="Plan"><option>Básico anual</option><option>Destacado anual</option><option>Premium anual</option><option>Banner / auspicio</option></select></div><div class="form-field"><label>¿Tienes fotos listas?</label><select name="Fotos listas"><option>Sí, tengo fotos</option><option>Necesito ayuda con fotos</option><option>Quiero publicar y completar después</option></select></div><div class="form-field full"><label>Descripción del negocio</label><textarea name="Descripción" placeholder="Describe servicios, capacidad, horarios, especialidades, valores referenciales o beneficios para turistas."></textarea></div><div class="form-field full"><label>Servicios principales</label><textarea name="Servicios" placeholder="Ej: piscina, tinaja, estacionamiento, comida chilena, menú, pet friendly, reservas, delivery, souvenirs, tours."></textarea></div><div class="form-field full"><button class="btn primary" type="submit">Enviar solicitud por WhatsApp</button></div></div></div></form></div></section>
