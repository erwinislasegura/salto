...
$siteConfig = $siteConfig ?? [
    ...
    'nav' => [
        ...
        'alojamientos' => ['label' => 'Alojamientos', 'href' => 'category.php?slug=alojamientos'],
        'restaurantes' => ['label' => 'Restaurantes', 'href' => 'category.php?slug=restaurantes'],
        'emprendimientos' => ['label' => 'Emprendimientos', 'href' => 'category.php?slug=emprendimientos'],
        'experiencias' => ['label' => 'Experiencias', 'href' => 'category.php?slug=experiencias'],
        'que-visitar' => ['label' => 'Qué visitar', 'href' => 'category.php?slug=que-visitar'],
